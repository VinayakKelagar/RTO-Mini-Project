...
(101, 'Himanshu', 'Vikram Singh', '1999-12-24', 'B+', 'House',9876543210, 'M',2147483647, 'himanshu@gmail.com', 'Bahadurgarh', 1, 1, '2019-04-17', '2019-04-30', '2019-05-02');
...
INSERT INTO `RTO_Code` (`RTO_Code`, `Branch_Name`,`Branch_City`,`STD_Code`) VALUES
(`HUB564`, `HubRto`,`HUBLI`,`580024`);
...
--
-- Indexes for table `RTO Barnch`
--
ALTER TABLE `RTO_Branch`
  ADD PRIMARY KEY (`RTO_Code`);  
