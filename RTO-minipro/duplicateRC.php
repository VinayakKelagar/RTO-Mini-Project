        ...
        <div class="col-lg-6 m-auto d-block">
            <form method="POST" onsubmit="return validation()" class="bg-light">
                <div class="form-group">
					...
					<input type="number"  placeholder="Vehicle Number should be of 6 digits" name="vehicleNumber" class="form-control" id="vehicleNumber" value="<?php echo $vehicleNumber;?>">
                ...
                <div class="form-group">
					...
					<input type="number" placeholder="Chassis Number should be of 6 digits" name="chassisNumber" class="form-control" id="chassisNumber" value="<?php echo $chassisNumber;?>">
                ...
                <div class="form-group">
					...
					<input type="number" placeholder="Engine Number should be of 10 digits" name="engineNumber" class="form-control" id="engineNumber" value="<?php echo $engineNumber;?>">
                ...
                <div class="form-group">
					...
					<input type="number" placeholder="Aadhar Number should be of 10 digits" name="aadharNumber" class="form-control" id="aadharNumber" value="<?php echo $aadharNumber;?>">
