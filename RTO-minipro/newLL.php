        ...
        <div class="col-lg-6 m-auto d-block">
            <form method="POST" onsubmit="return validation()" class="bg-light">
                <div class="form-group">
					...
					<input type="text" placeholder="Name" name="name" class="form-control" id="name" value="<?php echo $name; ?>">
                ...
                <div class="form-group">
					...
					<input type="text" placeholder="Father Name" name="fatherName" class="form-control" id="fatherName" value="<?php echo $fatherName; ?>">
					<span id="fatherNameerr" class="text-danger font-weight-bold"> </span>
				</div>
                <div class="form-group">
					<label for="dob" class="font-weight-bold"> Enter DOB: </label>
					<input type="date" placeholder="Date Of Birth" name="dob" class="form-control" id="dob" value="<?php echo $dob; ?>">
                ...
                <div class="form-group">
					...
					<input type="text" placeholder="Blood Group" name="bloodGroup" class="form-control" id="bloodGroup" value="<?php echo $bloodGroup; ?>">
                ...
                <div class="form-group">
					...
					<input type="text" placeholder="Address" name="address" class="form-control" id="address" value="<?php echo $email; ?>">
                ...
                <div class="form-group">
					...
					<input type="text" placeholder="Aadhar No should be of 10 digits" name="aadhar" class="form-control" id="aadhar" value="<?php echo $aadhar; ?>">
                ...
                <div class="form-group">
					...
					<input type="email" placeholder="Ex: example@gmail.com" name="email" class="form-control" id="email" value="<?php echo $email; ?>">
					<span id="emailerr" class="text-danger font-weight-bold"> </span>
				</div>
                <div class="form-group">
					<label for="rto" class="font-weight-bold"> Enter RTO Office: </label>
					<input type="text" placeholder="RTO Branch" name="rto" class="form-control" id="rto" value="<?php echo $rto; ?>">
					<span id="rtoerr" class="text-danger font-weight-bold"> </span>
				</div>
                <center><input type="submit" name="submit" value="SUBMIT" class="btn btn-success" href="llstatus.php"><center>
            </form>
            <br>
        </div>
    </div>
