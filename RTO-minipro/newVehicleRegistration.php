        ...
        <div class="col-lg-6 m-auto d-block">
            <form method="POST" onsubmit="return validation()" class="bg-light">
                <div class="form-group">
					...
					<input type="number" placeholder="Temp No should be of 10 digits" name="tempNo" class="form-control" id="tempNo" value="<?php echo $tempNo;?>"> 
					<span id="tempNoerr" name="tempNoerr" class="text-danger font-weight-bold"> <?php echo $tempNoerr;?> </span>
				</div>

                <div class="form-group">
					<label for="name" class="font-weight-bold"> Name: </label>
					<input type="text" placeholder="Name cannot contain anything other than characters" name="name" class="form-control" id="name" value="<?php echo $name;?>">
					<span id="nameerr" class="text-danger font-weight-bold"> </span>
				</div>

                <div class="form-group">
					<label for="aadhar" class="font-weight-bold"> Aadhar Number: </label>
					<input type="number" placeholder="Aadhar No should be of 10 digits" name="aadhar" class="form-control" id="aadhar" value="<?php echo $aadhar;?>">
					<span id="aadharerr" class="text-danger font-weight-bold"> </span>
				</div>

                <div class="form-group">
					<label for="chassisNo" class="font-weight-bold"> Chassis Number: </label>
					<input type="number" placeholder="Chassis No should be of 6 digits" name="chassisNo" class="form-control" id="chassisNo" value="<?php echo $chassisNo;?>">
                ...
                <div class="form-group">
					...
					<input type="number" placeholder="Engine No should be of 10 digits" name="engineNo" class="form-control" id="engineNo" value="<?php echo $engineNo;?>">
                ...
                <div class="form-group">
					...
					<input type="text" placeholder="Ex: class A, class B" name="vehicleClass" class="form-control" id="vehicleClass" value="<?php echo $vehicleClass;?>">
					<span id="vehicleClasserr" class="text-danger font-weight-bold"> </span>
				</div>

                <div class="form-group">
					<label for="color" class="font-weight-bold"> Color: </label>
					<input type="text" placeholder="Ex: white, black, blue, gray" name="color" class="form-control" id="color" value="<?php echo $color;?>">
					<span id="colorerr" class="text-danger font-weight-bold"> </span>
				</div>

                <div class="form-group">
					<label for="fuelType" class="font-weight-bold"> Fuel Type: </label>
					<input type="text" placeholder="Ex: Diesel, Petrol" name="fuelType" class="form-control" id="fuelType" value="<?php echo $fuelType;?>">
                ...
                <div class="form-group">
					...
					<input type="text" placeholder="Enter Number Of Seats" name="seatingType" class="form-control" id="seatingType" value="<?php echo $seatingType;?>">
					<span id="seatingTypeerr" class="text-danger font-weight-bold"> </span>
				</div>

                <div class="form-group">
					<label for="rto" class="font-weight-bold"> RTO: </label>
					<input type="text" placeholder="Enter RTO Branch" name="rto" class="form-control" id="rto" value="<?php echo $rto;?>">
